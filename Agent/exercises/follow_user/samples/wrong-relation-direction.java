public interface NetworkInterface {
    /*@ public normal_behavior
      ...
      @ assignable users[*];
      @ ensures getUser(id2).isFollowing(getUser(id1));
      @ ensures getUser(id1).containsFollower(getUser(id2));
      ...
      @ signals (DuplicateSubscriptionException e) containsUser(id1) && containsUser(id2)
